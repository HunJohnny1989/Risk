 ...
 * @author orsi
 */
public class Player implements MissionAgent, Serializable {
     ...
     * @author Sajti Tamás
     */
    public BattleResult attack(Territory attackingTerritory, Territory defendingTerritory, int attackingTroopCount, Model model) {
        Battle battle = new Battle(attackingTerritory, defendingTerritory, attackingTroopCount, model);
    ...
    /**
     * @author Sajti Tamás for testing hasOccupiedContinents
     */
    ...
    public void setOccupiedTerritories(List<Territory> occupiedTerritories) {
